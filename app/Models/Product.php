...
class Product extends Model
{
    ...
    protected $fillable = [
        ...
        'imageDesc3', 'imageCaption3', 'imageTitle3', 'imageAlt3', 'icon', 'description', 'productHeading3', 
        'productHeading2', 'productHeading1', 'seoUrl', 'sortOrder', 'sortOrderPopular', 'sortOrderCategory', 
        'sortOrderSubCategory', 'metaTitle', 'metaKeyword', 'metaDescription', 'metaImage', 'productDesc3', 
