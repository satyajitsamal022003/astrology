...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{url('/')}}/user/assets/js/plugin/airdatepicker/datepicker.min.css"/>
    <link rel="stylesheet" type="text/css" href="{{url('/')}}/user/assets/css/all.min.css"/>
    <link rel="stylesheet" type="text/css" href="{{url('/')}}/user/assets/css/mega-menu458e.css?=10"/>
    <link rel="stylesheet" type="text/css" href="{{url('/')}}/user/assets/css/style552d.css?=43.2"/>
    <link rel="stylesheet" type="text/css" href="{{url('/')}}/user/assets/css/aos.css"/>
    <link rel="stylesheet" type="text/css" href="{{url('/')}}/user/assets/css/easy-responsive-tabs.css"/>
    <!-- Fotorama -->
                ...
                <div class="top-right">
                    ...
                    <div class="menu-right">
                        <div class="header-login position-relative">
                            <a href="login.html"><i class="fa-light fa-circle-user"></i> Login/Signup</a>
                            <div class="header-login-dropdown">
                                <ul>
                                    <li><a href="my-profile.html"><i class="fa-light fa-circle-user"></i> My Profile</a></li>
                                    <li><a href="my-order.html"><i class="fa-light fa-box-taped"></i> My Order</a></li>
                                    <li><a href="wishlist.html"><i class="fa-light fa-heart"></i> Wishlist</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="header-cart"><a href="cart.html"><i class="fa-light fa-cart-shopping"></i><span>0</span></a></div>
                    </div>

                    <!--login and cart section end-->

                    <ul class="social-link">
                        <li><a href="#" title="Facebook" target="_blank"><i class="fa-brands fa-facebook-f"></i></a>
                        </li>
                        <li><a href="#" title="Twitter" target="_blank"><i class="fa-brands fa-twitter"></i></a></li>
                        <li><a href="#" title="Instagram" target="_blank"><i class="fa-brands fa-instagram"></i></a>
                        </li>
                        <li><a href="#" title="YouTube" target="_blank"><i class="fa-brands fa-youtube"></i></a></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="main-menu">
                    ...
                    <div class="main_menu inline-menu">
                        <div class="as_info_detail mobile-none">
                            <div class="as_logo">
                                <a href="index.html">
                                    <img src="{{url('/')}}/user/assets/images/logo708a.png?=1" alt="">
                                </a>
                            </div>
                        </div>
                        <ul class="menu-section">
                            ...
                            <li class="mega_menu_dropdown mega_menu_demo_2 has_dropdown">
                                <a href="category.html">Gemstones</a><span
                                    class="arrow-icon"><i
                                    class="fas fa-angle-down"></i></span>
                                <div class="mega_menu sub_menu container">

                                    <div class="mega_menu_item">
                                        <a href="#"><span><img  src="1.jpg"></span>Amethyst (Standard Quality)</a>
                                    </div>
                                    <div class="mega_menu_item">
                                        <a href="#"><span><img  src="1.jpg"></span>Amethyst (Standard Quality)</a>
                                    </div>
                                    ...
                                    <div class="view-all">
                                        <a href="category.html">View All <i class="fa-solid fa-chevrons-right"></i></a>
                                    </div>
                            </li>
                    ...
                    <span class="right_btn">
                      <button type="button" class="btn_top" id="search-top">
                         <img src="{{url('/')}}/user/assets/images/search.png" alt="search-image" title="Search">
                      </button>
                    </span>
                            ...
                            <div class="search-form">
                                <div class="container">
                                    ...
                                    <div class="closed_btn"><label for="search"><img
                                            src="{{url('/')}}/user/assets/images/cancel-white.png" alt="image"></label></div>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                    ...
                    <div class="row">
                            ...
                            <div class="as_footer_widget">
                                ...
                                <ul class="as_contact_list">
                                    ...
                                    <li>
                                        ...
                                        <a href="https://goo.gl/maps/sPAPcT8hU8fhtetH7"
                                           target="_blank"><p>Plot No - A/88, Saheed Nagar<br/>
                                            Bhubaneswar, Odisha - 751007</p></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-12 col-12">
                            <div class="as_footer_widget">
                                ...
                                <ul>
                                    <li><a href="category.html">Gemstones</a></li>
                                    <li><a href="category.html">Rudraksha</a></li>
                                    <li><a href="category.html">Bracelet</a></li>
                                    <li><a href="category.html">Mala</a></li>
                                    <li><a href="category.html">Puja Material</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-12 col-12">
                            <div class="as_footer_widget mt_top">
                                <ul>
                                    <li><a href="category.html">Seashell</a></li>
                                    <li><a href="category.html">Yantra</a></li>
                                    <li><a href="category.html">Vastu Material</a></li>
                                    <li><a href="category.html">Herbs</a></li>
                                </ul>
                            </div>
                        </div>
                                ...
                                <div class="as_newsletter_wrapper mt-3">
                                    <div class="as_newsletter_box">
                                        ...
                                        <a href="javascript:;" class="as_btn">
                                            <img src="{{url('/')}}/user/assets/images/svg/plane.svg" alt="">
                                        </a>
                                    </div>
                                </div>
                ...
                <div class="middle-link-footer">
                    <a href="cms-page.html">About Us</a> <span>||</span> <a
                        href="cms-page.html">Terms &amp; Conditions</a> <span>||</span> <a
                        href="cms-page.html">Privacy Policy</a> <span>||</span> <a
                        href="cms-page.html">Disclaimer</a> <span>||</span> <a
                        href="cms-page.html">Grievance Redressal</a> <span>||</span> <a
                        href="cms-page.html">Cancellation/Refund</a> <span>||</span> <a
                        href="cms-page.html">Shipping And Delivery</a></div>
