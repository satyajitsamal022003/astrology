                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="center action">
                                            ...
                                            <a href="{{ route('admin.deletecouriertype', $courierType->id) }}" class="btn btn-sm bg-danger mr-2" onclick="return confirm('Are you sure you want to delete this courier type?');" title="Delete">
