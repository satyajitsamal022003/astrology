                                                ...
                                                <div class="row">
                                                    <div class="col-xl-8">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" id="" placeholder="Product Name" name="productName" required value="{{ $product->productName }}">
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Product Small Name (To show on the variant)</label>
                                                            <input class="form-control" id="" placeholder="Product Small Name" name="variantName" required value="{{ $product->variantName }}">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="">Category </label>
                                                            <select class="form-control" id="categoryId" name="categoryId" onchange="getSubCategory(this.value)" required >
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xl-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control" placeholder="Price MRP" name="priceMRP" required value="{{ $product->priceMRP }}">
                                                                </div>
                                                            </div>
                                                            <div class="col-xl-4">
                                                                <div class="form-group">
                                                                    <label>Price B2C</label>
                                                                    <input class="form-control" placeholder="Price B2C" name="priceB2C" required value="{{ $product->priceB2C }}">
                                                                </div>
                                                            </div>
                                                            <div class="col-xl-4">
                                                                <div class="form-group">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                                                ...
                                                                <input type="number" class="form-control" id="" name="min_product_qty" value="{{ $product->min_product_qty }}">
                                                            </div>
                                                            <div class="col-lg-6">
                                                                <label>Higher product range</label>
                                                                <input type="number" class="form-control" id="" name="max_product_qty" value="{{ $product->max_product_qty }}">
                                                            </div>
                                                        </div>
                                                        <div class="row mt-2">
                                                            <div class="col-xl-12">
                                                                <label for="out_of_stock" class="flex items-center">
                                                                    <input id="out_of_stock" type="checkbox" class="form-checkbox" name="out_of_stock" value="1" {{ $product->out_of_stock ? 'checked' : '' }}>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" id="" name="certificationId">
                                                                ...
                                                                <option value="1" {{ "1" == $product->certificationId ? 'selected' : '' }}> 250 (Amount)</option>
                                                                <option value="2" {{ "2" == $product->certificationId ? 'selected' : '' }}> Free</option>
                                                                <option value="3" {{ "3" == $product->certificationId ? 'selected' : '' }}> N/A</option>
                                                            </select>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="">Activation</label>
                                                            <select class="form-control" name="activationId" value="{{ $product->activationId }}">
                                                                <option>--Select--</option>
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" placeholder="Heading 1" name="productHeading1" value="{{ $product->productHeading1 }}">
                                                </div>
                                                <div class="form-group">
